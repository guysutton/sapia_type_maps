...
# *** This is not my function - I have slightly edited the function written 
#     by Keaton Wilson because I have issues with the 'select' function required
#     dplyr::select, being overridden by raster::select when using Keaton's script
#     in my workflow. 
...
get_clean_obs = function(genus = NULL, species = NULL, lonlim = c(-180, 180), latlim = c(-90, 90)) {
